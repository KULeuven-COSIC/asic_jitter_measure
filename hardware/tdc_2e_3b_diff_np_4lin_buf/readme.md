# `tdc_2e_3b_diff_np_4lin_buf` Module
![Layout](tdc_2e_3b_diff_np_4lin_buf.png)

## Cell Hierarchy

`tdc_2e_3b_diff_np_4lin_buf` **466** (number MOS pairs)
- `tdc_2stage_diff_np_4lin_buf` **116** *x3*
